...
set ::env(CURRENT_DEF) /foss/designs/modulo4/lab02/runs/util_30/08-openroad-floorplan/sar_controller.def
set ::env(SAVE_ODB) /foss/designs/modulo4/lab02/runs/util_30/09-openroad-dumprcvalues/sar_controller.odb
set ::env(SAVE_DEF) /foss/designs/modulo4/lab02/runs/util_30/09-openroad-dumprcvalues/sar_controller.def
set ::env(SAVE_SDC) /foss/designs/modulo4/lab02/runs/util_30/09-openroad-dumprcvalues/sar_controller.sdc
set ::env(SAVE_NL) /foss/designs/modulo4/lab02/runs/util_30/09-openroad-dumprcvalues/sar_controller.nl.v
set ::env(SAVE_PNL) /foss/designs/modulo4/lab02/runs/util_30/09-openroad-dumprcvalues/sar_controller.pnl.v
