...
set ::env(CURRENT_ODB) /foss/designs/modulo4/lab02/runs/util_30/32-openroad-globalrouting/sar_controller.odb
set ::env(SAVE_ODB) /foss/designs/modulo4/lab02/runs/util_30/35-openroad-repairantennas/1-diodeinsertion/sar_controller.odb
set ::env(SAVE_DEF) /foss/designs/modulo4/lab02/runs/util_30/35-openroad-repairantennas/1-diodeinsertion/sar_controller.def
