...
set ::env(CURRENT_NL) /foss/designs/modulo4/lab02/runs/util_30/45-openroad-fillinsertion/sar_controller.nl.v
set ::env(CURRENT_SPEF) "\"nom_*\" /foss/designs/modulo4/lab02/runs/util_30/47-openroad-rcx/nom/sar_controller.nom.spef \"min_*\" /foss/designs/modulo4/lab02/runs/util_30/47-openroad-rcx/min/sar_controller.min.spef \"max_*\" /foss/designs/modulo4/lab02/runs/util_30/47-openroad-rcx/max/sar_controller.max.spef"
set ::env(CURRENT_ODB) /foss/designs/modulo4/lab02/runs/util_30/46-odb-cellfrequencytables/sar_controller.odb
set ::env(SAVE_SDC) /foss/designs/modulo4/lab02/runs/util_30/48-openroad-stapostpnr/sar_controller.sdc
