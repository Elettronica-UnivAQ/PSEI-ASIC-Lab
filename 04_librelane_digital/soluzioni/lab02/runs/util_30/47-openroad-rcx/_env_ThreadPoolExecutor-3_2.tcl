...
set ::env(CURRENT_DEF) /foss/designs/modulo4/lab02/runs/util_30/46-odb-cellfrequencytables/sar_controller.def
...
set ::env(SAVE_SPEF) /foss/designs/modulo4/lab02/runs/util_30/47-openroad-rcx/max/sar_controller.max.spef
