...
set ::env(CURRENT_ODB) /foss/designs/modulo4/lab02/runs/util_30/30-openroad-resizertimingpostcts/sar_controller.odb
set ::env(SAVE_ODB) /foss/designs/modulo4/lab02/runs/util_30/32-openroad-globalrouting/sar_controller.odb
set ::env(SAVE_DEF) /foss/designs/modulo4/lab02/runs/util_30/32-openroad-globalrouting/sar_controller.def
