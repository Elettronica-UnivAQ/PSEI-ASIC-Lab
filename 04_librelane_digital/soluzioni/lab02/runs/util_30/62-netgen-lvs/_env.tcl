...
set ::env(CURRENT_SPICE) /foss/designs/modulo4/lab02/runs/util_30/60-magic-spiceextraction/sar_controller.spice
set ::env(CURRENT_PNL) /foss/designs/modulo4/lab02/runs/util_30/45-openroad-fillinsertion/sar_controller.pnl.v
