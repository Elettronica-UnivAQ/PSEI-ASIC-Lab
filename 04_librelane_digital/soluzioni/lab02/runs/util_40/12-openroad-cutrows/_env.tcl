...
set ::env(CURRENT_ODB) /foss/designs/modulo4/lab02/runs/util_40/08-openroad-floorplan/sar_controller.odb
set ::env(SAVE_ODB) /foss/designs/modulo4/lab02/runs/util_40/12-openroad-cutrows/sar_controller.odb
set ::env(SAVE_DEF) /foss/designs/modulo4/lab02/runs/util_40/12-openroad-cutrows/sar_controller.def
