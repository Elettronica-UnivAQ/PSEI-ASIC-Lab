...
set ::env(CURRENT_DEF) /foss/designs/modulo4/lab02/runs/util_40/46-odb-cellfrequencytables/sar_controller.def
...
set ::env(SAVE_SPEF) /foss/designs/modulo4/lab02/runs/util_40/47-openroad-rcx/nom/sar_controller.nom.spef
