set ::env(TRACKS_INFO_FILE_PROCESSED) /foss/designs/modulo4/lab02/runs/util_40/08-openroad-floorplan/config.tracks
...
set ::env(CURRENT_NL) /foss/designs/modulo4/lab02/runs/util_40/01-yosys-vhdlsynthesis/sar_controller.nl.v
set ::env(SAVE_ODB) /foss/designs/modulo4/lab02/runs/util_40/08-openroad-floorplan/sar_controller.odb
set ::env(SAVE_DEF) /foss/designs/modulo4/lab02/runs/util_40/08-openroad-floorplan/sar_controller.def
set ::env(SAVE_SDC) /foss/designs/modulo4/lab02/runs/util_40/08-openroad-floorplan/sar_controller.sdc
set ::env(SAVE_NL) /foss/designs/modulo4/lab02/runs/util_40/08-openroad-floorplan/sar_controller.nl.v
set ::env(SAVE_PNL) /foss/designs/modulo4/lab02/runs/util_40/08-openroad-floorplan/sar_controller.pnl.v
