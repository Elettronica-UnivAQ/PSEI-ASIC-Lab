...
set ::env(DRT_ANTENNA_REPAIR_ITERS) 0
set ::env(DRT_ANTENNA_MARGIN) 10
set ::env(CURRENT_ODB) /foss/designs/modulo4/lab02/runs/RUN_2026-05-12_18-02-55/35-openroad-repairantennas/1-diodeinsertion/sar_controller.odb
set ::env(SAVE_ODB) /foss/designs/modulo4/lab02/runs/RUN_2026-05-12_18-02-55/37-openroad-detailedrouting/sar_controller.odb
set ::env(SAVE_DEF) /foss/designs/modulo4/lab02/runs/RUN_2026-05-12_18-02-55/37-openroad-detailedrouting/sar_controller.def
set ::env(SAVE_SDC) /foss/designs/modulo4/lab02/runs/RUN_2026-05-12_18-02-55/37-openroad-detailedrouting/sar_controller.sdc
set ::env(SAVE_NL) /foss/designs/modulo4/lab02/runs/RUN_2026-05-12_18-02-55/37-openroad-detailedrouting/sar_controller.nl.v
set ::env(SAVE_PNL) /foss/designs/modulo4/lab02/runs/RUN_2026-05-12_18-02-55/37-openroad-detailedrouting/sar_controller.pnl.v
