...
set ::env(CURRENT_ODB) /foss/designs/modulo4/lab02/runs/util_55/27-openroad-detailedplacement/sar_controller.odb
set ::env(SAVE_ODB) /foss/designs/modulo4/lab02/runs/util_55/28-openroad-cts/sar_controller.odb
set ::env(SAVE_DEF) /foss/designs/modulo4/lab02/runs/util_55/28-openroad-cts/sar_controller.def
set ::env(SAVE_SDC) /foss/designs/modulo4/lab02/runs/util_55/28-openroad-cts/sar_controller.sdc
set ::env(SAVE_NL) /foss/designs/modulo4/lab02/runs/util_55/28-openroad-cts/sar_controller.nl.v
set ::env(SAVE_PNL) /foss/designs/modulo4/lab02/runs/util_55/28-openroad-cts/sar_controller.pnl.v
