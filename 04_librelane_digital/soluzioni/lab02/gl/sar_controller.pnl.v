// Gate-level defines e include celle SKY130A
`define UNIT_DELAY #1
`define FUNCTIONAL
...
module sar_controller (clk,
 ...
 sky130_fd_sc_hd__inv_1 _072_ (.A(net37),
    ...
    .VPWR(VPWR),
    .Y(_046_));
 sky130_fd_sc_hd__inv_1 _073_ (.A(net36),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__inv_1 _075_ (.A(net38),
    ...
    .VPWR(VPWR),
    .Y(net39));
 sky130_fd_sc_hd__and2b_4 _076_ (.A_N(net35),
    .B(net34),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_049_));
 sky130_fd_sc_hd__nand2b_2 _077_ (.A_N(net35),
    .B(\state[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nor2_2 _093_ (.A(net36),
    ...
    .VPWR(VPWR),
    .Y(_060_));
 sky130_fd_sc_hd__or3_4 _094_ (.A(net36),
    .B(net35),
    .C(\state[3] ),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__o21a_1 _098_ (.A1(_063_),
    ...
    .VPWR(VPWR),
    .X(_001_));
 sky130_fd_sc_hd__o21a_1 _099_ (.A1(net35),
    .A2(_054_),
    .B1(net26),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__mux2_1 _111_ (.A0(_048_),
    ...
    .VPWR(VPWR),
    .X(_028_));
 sky130_fd_sc_hd__or2_1 _112_ (.A(net33),
    .B(_028_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__mux2_1 _117_ (.A0(_048_),
    ...
    .VPWR(VPWR),
    .X(_032_));
 sky130_fd_sc_hd__or2_1 _118_ (.A(net33),
    .B(_032_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__mux2_1 _124_ (.A0(_048_),
    ...
    .VPWR(VPWR),
    .X(_035_));
 sky130_fd_sc_hd__or2_1 _125_ (.A(net33),
    .B(_035_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__mux2_1 _128_ (.A0(net7),
    ...
    .VPWR(VPWR),
    .X(_037_));
 sky130_fd_sc_hd__or2_1 _129_ (.A(net33),
    .B(_037_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__or2_1 _131_ (.A(_031_),
    ...
    .VPWR(VPWR),
    .X(_014_));
 sky130_fd_sc_hd__a31o_1 _132_ (.A1(net43),
    .A2(_057_),
    .A3(_062_),
    .B1(_034_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__o21ai_1 _136_ (.A1(_067_),
    ...
    .VPWR(VPWR),
    .Y(_017_));
 sky130_fd_sc_hd__nor2_1 _137_ (.A(net49),
    .B(_000_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__mux2_1 _142_ (.A0(net19),
    ...
    .VPWR(VPWR),
    .X(_042_));
 sky130_fd_sc_hd__or2_1 _143_ (.A(_060_),
    .B(_042_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o21a_1 _144_ (.A1(_050_),
    ...
    .VPWR(VPWR),
    .X(_043_));
 sky130_fd_sc_hd__or3_1 _145_ (.A(_060_),
    .B(_066_),
    .C(_043_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__o31a_1 _146_ (.A1(_046_),
    ...
    .VPWR(VPWR),
    .X(_044_));
 sky130_fd_sc_hd__or3_1 _147_ (.A(_060_),
    .B(_067_),
    .C(_044_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__and2b_1 _148_ (.A_N(_000_),
    ...
    .VPWR(VPWR),
    .X(_045_));
 sky130_fd_sc_hd__or3_1 _149_ (.A(_060_),
    .B(_063_),
    .C(_045_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_1 _150_ (.CLK(clknet_2_0__leaf_clk_regs),
    ...
    .VPWR(VPWR),
    .Q(net24));
 sky130_fd_sc_hd__dfrtp_1 _151_ (.CLK(clknet_2_2__leaf_clk_regs),
    .D(_002_),
    .RESET_B(net9),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_4 _158_ (.CLK(clknet_2_3__leaf_clk_regs),
    ...
    .VPWR(VPWR),
    .Q(\state[1] ));
 sky130_fd_sc_hd__dfrtp_4 _159_ (.CLK(clknet_2_2__leaf_clk_regs),
    .D(\:61.Y[2] ),
    .RESET_B(net11),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_4 _161_ (.CLK(clknet_2_3__leaf_clk_regs),
    ...
    .VPWR(VPWR),
    .Q(net38));
 sky130_fd_sc_hd__dfstp_1 _162_ (.CLK(clknet_2_3__leaf_clk_regs),
    .D(_009_),
    .SET_B(net11),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfstp_1 _176_ (.CLK(clknet_2_0__leaf_clk_regs),
    ...
    .VPWR(VPWR),
    .Q(net19));
 sky130_fd_sc_hd__dfstp_1 _177_ (.CLK(clknet_2_2__leaf_clk_regs),
    .D(_023_),
    .SET_B(net9),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__buf_1 input2 (.A(rst_n),
    ...
    .VPWR(VPWR),
    .X(net2));
 sky130_fd_sc_hd__clkbuf_1 fanout9 (.A(net10),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net9));
 sky130_fd_sc_hd__buf_1 fanout10 (.A(net2),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net10));
 sky130_fd_sc_hd__clkbuf_1 fanout11 (.A(net12),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_1 output30 (.A(net39),
    ...
    .VPWR(VPWR),
    .X(phi_sample_n));
 sky130_fd_sc_hd__buf_2 wire31 (.A(net9),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net40));
 sky130_fd_sc_hd__clkbuf_2 max_cap32 (.A(net11),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkinv_2 clkload0 (.A(clknet_2_1__leaf_clk_regs),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__clkinv_1 clkload1 (.A(clknet_2_2__leaf_clk_regs),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 ...
 sky130_fd_sc_hd__dlygate4sd3_1 hold2 (.A(net5),
    ...
    .VPWR(VPWR),
    .X(net44));
 sky130_fd_sc_hd__dlygate4sd3_1 hold3 (.A(\state[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net45));
 sky130_fd_sc_hd__dlygate4sd3_1 hold4 (.A(\:61.Y[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__dlygate4sd3_1 hold7 (.A(net4),
    ...
    .VPWR(VPWR),
    .X(net49));
 sky130_fd_sc_hd__dlygate4sd3_1 hold8 (.A(net38),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__fill_1 FILLER_0_6 (.VGND(VGND),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__decap_3 FILLER_0_10 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__decap_3 FILLER_0_13 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 ...
 sky130_fd_sc_hd__decap_3 FILLER_15_49 (.VGND(VGND),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__decap_3 FILLER_15_52 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 ...
 sky130_fd_sc_hd__fill_1 FILLER_21_103 (.VGND(VGND),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__decap_3 FILLER_21_107 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
