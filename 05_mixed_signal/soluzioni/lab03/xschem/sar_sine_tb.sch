...
N -300 120 -300 150 {lab=GND}
N -300 10 -300 60 {lab=VIN_N}
...
C {vsource.sym} -410 120 0 0 {name=Vinp value="0  SIN(0.900 0.120 93750 0 0 0)" savecurrent=false}
C {vsource.sym} -300 90 0 0 {name=Vinn value=0.9 savecurrent=false}
...
"
spice_ignore=false}
C {code_shown.sym} -770 170 0 0 {name=commands 
only_toplevel=false 
value="
...
C {launcher.sym} 410 -530 0 0 {name=h5
descr="load waves" 
tclcommand="xschem raw_read $netlist_dir/sar_sine_tb.raw tran"
}
